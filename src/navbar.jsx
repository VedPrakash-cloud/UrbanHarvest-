    ...
    return (
            <nav className="container fixed top-0 bg-white z-999 flex justify-between items-center-safe lg:px-10 shadow-sm w-full">
                ...
                <div className="right-menu flex items-center-safe gap-2 lg:gap-5 mx-1 lg:mx-5">
                    <div className="search-box p-1 flex items-center-safe w-[75%] md:max-w-fit gap-2 border border-gray-300 rounded-3xl cursor-auto">
                        <RiSearchLine size={40} className="text-gray-400"/>
                        <input type="text" id="items" placeholder="search for products..." className="outline-none"/>
                    </div>
                    <div className="relative">
                        <RiShoppingCart2Line size={40} onClick={onCartClick} className="text-[#076633] border border-[#076633] p-2 rounded-full cursor-pointer"/>
                        {count > 0 && (
