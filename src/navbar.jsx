...
export default function Navbar({count}){
    ...
    return (
        <>
            <nav className="container fixed top-0 bg-white z-999 flex justify-between items-center-safe px-10 shadow-sm w-full">
                <img src={Logo} alt="Urban Harvest" title="Urban Harvest" className="cursor-pointer" />
                <div className="right-menu flex items-center-safe gap-5 mx-5">
                    <div className="search-box p-2 flex items-center-safe max-w-fit gap-2 border border-gray-300 rounded-3xl cursor-auto">
